	...
	function language(l){
		...
		switch(l) {
		    ...
		    case "jp": //日文
		        ...
		        s3Content = "A.Brolly Stonehengeには、無水染色、リサイクルPETボトル製の傘生地、フルオロカーボンフリーの生地や撥水性加工など、当社独自のEcoStream技術が採用されています。 さらには、A.Brolly Stonehengeのキャノピーは直径122cmの大型であり、一度に3人から4人までカバーできるのです！";
		        ...
		        s10ContentStory5 = "A.Brollyの哲学は、廃棄物として、毎年、生み出される傘の数を削減する為に、10年以上使い続けることの出来る高品質の傘を作ることです。同時に、機能性、ファッシン性に富み、また環境に優しい製品を生産するための新素材の研究開発を続けていきます。<br>A.Brollyを手にし、優れた傘のあるべき姿を、是非、知って頂けたらと思います。";
