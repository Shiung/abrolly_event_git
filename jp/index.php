...
<html lang="en">
  <head>
	...
	})(window,document,'script','dataLayer','GTM-PXWTCKC');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PXWTCKC"
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 s1Box d-flex flex-column justify-content-center align-items-center">
				...
				<div class="sale-jp-logo">
					<img src="../img/uk.png" class="img-fluid" alt="">
				</div>
				<div class="sale-jp-logo-2">
					<img src="../img/Green_LOGO.jpg" class="img-fluid" alt="">
				</div>
				<!-- scrollDown -->
